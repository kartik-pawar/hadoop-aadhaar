                                ...
                                .done(function(data){
                                    ...
                                    $('#waitmale').hide();
                                     ...
                                     for (var key in data.male) {
                                             console.log(data.male[key].districtName);
                                             console.log(data.male[key].count);
                                             disttname.push(data.male[key].districtName);
                                             disttcount.push(data.male[key].count);
                                        }
                                ...
                                .done(function(data){
                                    ...
                                    $('#waitfemale').hide();
                                     ...
                                     for (var key in data.female) {
                                             console.log(data.female[key].districtName);
                                             console.log(data.female[key].count);
                                             disttname2.push(data.female[key].districtName);
                                             disttcount2.push(data.female[key].count);
                                        }
