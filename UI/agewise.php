                            ...
                            $(function () {
                                ...
                                .done(function(data){
                                    ...
                                    $('#wait').hide();
                                     ...
                                     for (var key in data.ageWise) {
                                             console.log(data.ageWise[key].ageGroup);
                                             console.log(data.ageWise[key].count);
                                             agegroup.push(data.ageWise[key].ageGroup);
                                             idcount.push(data.ageWise[key].count);
                                        }
